...
export class CockpitComponent implements OnInit {
  ...
  @ViewChild('serverContentInput') serverContentInput: ElementRef;//we know this property is a reference type of that DOM elment. it is referencing
  ...
  onAddServer(nameInput: HTMLInputElement) {
    ...
    this.serverCreated.emit({
      ...
      serverContent: this.serverContentInput.nativeElement.value});//now when this component triggers this function, it will emit an event of the type 
